...
from app.api.gateway_workspace import router as gateway_workspace_router
...
from app.api.task_generation import router as task_generation_router
...
OPENAPI_TAGS = [
    ...
    {
        "name": "channels",
        "description": "Gateway channel status proxy: live connection state for WhatsApp, iMessage, Telegram, etc.",
    },
    {
        "name": "metrics",
...
api_v1.include_router(gateway_workspace_router)
...
api_v1.include_router(task_generation_router)
